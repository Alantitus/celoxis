  ...
  return (
    <div  className='w-full h-screen bg-zinc-900 flex gap-5 font-["Roboto_Condensed"]'>
      ...
      <div className='heading'> 
            <h1 className='text-9xl uppercase font-semibold tracking-tighter mt-20 mx-20'>Eye-</h1>
            <h1 className='text-9xl uppercase font-semibold tracking-tighter mx-20 -mt-5'>Opening</h1>
      </div>
      <h3 className='font-bold text-2xl m-20'>Celoxis.</h3>
      </div>
      <div className='w-1/2'>
